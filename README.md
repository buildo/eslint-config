...
## Objects
  ...
  - [3.3](#3.3) <a name='3.3'></a> Use object method shorthand. eslint: [`object-shorthand`](http://eslint.org/docs/rules/object-shorthand.html)
  ...
  - [3.4](#3.4) <a name='3.4'></a> Use property value shorthand. eslint: [`object-shorthand`](http://eslint.org/docs/rules/object-shorthand.html)
  ...
  - [3.6](#3.6) <a name="3.8"></a> Only quote properties that are invalid identifiers. eslint: [`quote-props`](http://eslint.org/docs/rules/quote-props.html)
...
## Arrays
  ...
  - [4.2](#4.2) <a name='4.2'></a> Use array spreads `...` to copy arrays.
